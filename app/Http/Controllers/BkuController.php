...
class BkuController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'kode_rekening' => ['required', 'string', 'max:255', 'regex:/^\d+(\.\d+)+$/'],
            ...
            'kode_rekening.regex' => 'Format Kode Rekening tidak valid. Gunakan format angka dipisahkan titik, contoh: 5.1.02.01.01.0001',
            'uraian.required' => 'Uraian wajib diisi.',
            'uraian.min' => 'Uraian terlalu pendek, minimal :min karakter.',
            'penerima.required' => 'Nama Penerima wajib diisi.',
            'penerima.min' => 'Nama Penerima terlalu pendek, minimal :min karakter.',
            ...
            'pptk_id.exists' => 'PPTK yang dipilih tidak ditemukan dalam data.',
        ]);
