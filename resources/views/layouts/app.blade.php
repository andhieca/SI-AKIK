    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside
            ...
            <div class="flex flex-col items-center justify-center py-8 bg-bedas-900 shadow-md">
                <img src="https://siakik.kecbandungkab.com/public/images/logo-kab-bandung.png" alt="Logo" class="w-16 h-auto mb-3">
            ...
            <nav class="mt-8 px-4 space-y-2">
                ...
                @if(auth()->user()->role === 'camat')
                    <a href="{{ route('display') }}"
                        ...
                        <span class="font-medium">Display Monitoring</span>
                    </a>
                @endif
            ...
            <header class="flex items-center justify-between px-6 py-4 bg-white border-b lg:hidden">
                <div class="flex items-center">
                    ...
                    <div class="flex items-center ml-4">
                        <img src="https://siakik.kecbandungkab.com/public/images/logo-kab-bandung.png" alt="Logo" class="w-8 h-auto mr-2">
            ...
            <header class="hidden lg:flex items-center justify-between px-8 py-4 bg-white shadow-sm z-10">
                ...
                <div class="flex items-center space-x-6">
                    ...
                    <a href="{{ route('bku.scanner') }}"
                        class="text-gray-500 hover:text-bedas-600 transition p-2 rounded-full hover:bg-gray-100"
